...
<link rel="stylesheet" type="text/css" href="views/login/style/style.css">
<script type="text/javascript" src="views/login/js/script.js"></script>
<script type="text/javascript" src="views/login/js/ajax.js"></script>
